/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Connectivity/inc/QMSL_Connectivity_WiGig/QMSL_Connectivity_WiGig.h#27 $
 * $DateTime: 2017/10/09 10:06:43 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   This function will read a block of values from a WiGig address.

   \param address = address to read
   \param numValues = pointer to hold number of desired values/number of values read
   \param data = pointer to array hold read data (must allocate num desired values)
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_ReadBlock(
      HANDLE hResourceContext, 
      unsigned int address,
   ...
   This function will execute a WiGig Flows command.

   \param command = command string. 
   \code
      Format: <WDelegate-n>|FLOWS|<Command Name>|Interface|[param1,param2,...paramN] where n = interface number and command name is defined in KnownMbCommands.xml
      Example: "WDelegate-0|FLOWS|BB_SendTone|127.0.0.1:12348@PCI!wmp0|2,3
   \endcode
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_FlowCommand(
      HANDLE hResourceContext, 
      char* command,
      char* response);
   ...
   *******************************************************************************/
   ...
   This function will transmit packets at the specified MCS & insert to tx mode.
   ...
   *******************************************************************************/
   ...
   This function will transmit packets only at the specified MCS , not insert to tx mode.
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_TransmitPacketsOnly(
      HANDLE hResourceContext, 
      int numPackets, 
      double silencePeriod, 
      int mcs, 
   ...
   This function will transmit packets at the specified MCS and set the tx gain accroding to MCS, not insert to tx mode.
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_TransmitPackets_W_MCS_Gain(
      HANDLE hResourceContext, 
      int numPackets, 
      double silencePeriod, 
      int mcs, 
   ...
   *******************************************************************************/
   ...
   This function will do the internal calibrations to all modules.
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_DoInternalCalibAll(
      HANDLE hResourceContext
      );
   ...
   *******************************************************************************/
   ...
   This function gets the supported HW versions.

   \param versions = Output string with space delimited supported HW versions
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_GetSupportedHwVersions(
      HANDLE hResourceContext, 
      char* versions
      );
   ...
   This function set the HW version.

   \param version = HW version for connection (Must be in the set of supported HW versions)
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_SetHwVersion(
      HANDLE hResourceContext, 
      char* version
      );
   ...
   This function selects the device to be used.

   \param deviceName = "sparrow", "talyn", ...
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_SelectDevice(
      HANDLE hResourceContext, 
   ...
   This function select the sector & sector gain number to rf module.

   \param rfMode = "tx","rx"
   \param rficId = Id number of rfc module
   \param rfSectorNo = the sector number
   \param rfSectorGainNo = the secotr gain number
   \return true if successful, false if fail.

   \warning

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_setGainSectorNo(
      HANDLE hResourceContext, 
	  char *rfMode, 
	  unsigned int rficId ,
	  unsigned int rfSectorNo,
	  unsigned int rfSectorGainNo
	  );
