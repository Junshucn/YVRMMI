/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Connectivity/inc/QMSL_Connectivity_WLAN/QMSL_Connectivity_WLAN_Atheros.h#25 $
 * $DateTime: 2017/09/28 16:47:22 $
 *
 *
 ******************************************************************************
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   typedef bool( *asyncPMMessageCB2 )
   (
      unsigned int gain, 
	  unsigned int freq, 
	  unsigned int chainMask,
      double *powerLevel, 
	  unsigned int numAvg, 
	  unsigned int iTriggerType, 
	  int iTriggerLevel, 
   ...
   *******************************************************************************/
   ...
   \warning QLIB_FTM_WLAN_SetModuleType() must be called first to set the WLAN module type
   *******************************************************************************/
   QLIB_API char QLIB_FTM_WLAN_TLV2_CreateQ5
   (
      HANDLE hResourceContext,
   ...
   \warning QLIB_FTM_WLAN_SetModuleType() must be called first to set the WLAN module type
   *******************************************************************************/
   QLIB_API char QLIB_FTM_WLAN_TLV2_AddParamQ5
   (
      HANDLE hResourceContext,
      char *pKey, 
      char *pData 
   ...
   \warning QLIB_FTM_WLAN_SetModuleType() must be called first to set the WLAN module type
   *******************************************************************************/
   QLIB_API char QLIB_FTM_WLAN_TLV2_CompleteQ5
   (
      HANDLE hResourceContext
   ); 
   ...
   \warning QLIB_FTM_WLAN_SetModuleType() must be called first to set the WLAN module type
   *******************************************************************************/
   QLIB_API char QLIB_FTM_WLAN_TLV2_GetRspParamQ5
   (
      HANDLE hResourceContext,
      char *pKey, 
      char *pData
   ...
   \warning QLIB_FTM_WLAN_SetModuleType() must be called first to set the WLAN module type
   *******************************************************************************/
   QLIB_API char QLIB_FTM_WLAN_TLV2_CommandSendQ5
   (
      HANDLE hResourceContext,
      void *para
   );
  ...
  /******************************************************************************/
  /**
   Atheros WLAN command to send nart command

   Note: This command works only when target is awake.
       (Current supported chip set: AR93xx)
  
   \param   nartCommand = NART command
   \param   nartResponse0 = NART response 0
   \param   nartResponse1 = NART response 1

   \return true if successful, false if failure
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WLAN_SendNartCmd
   (
      HANDLE hResourceContext,
      char *nartCommand,
      char *nartResponse0,
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_WLAN_Atheros_xtal_CAL2
   (
   HANDLE hResourceContext,
   asyncCWFreqErrMessageCB2 pAsyncCWFreqErrMessageCB2, 
    unsigned int measAvg
   );
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_WLAN_Atheros_Tx_FW_CAL2
   (
   HANDLE hResourceContext,
   unsigned int phyId, 
   unsigned int calScheme, 
   unsigned int totalNumOfChains, 
   unsigned int multiChainMask, 
   unsigned int numAverages,
   asyncSetChainMessageCB pAsyncSetChainMessageCB,
   asyncPMMessageCB2 cb2,
   asyncRFSMessageCB asyncHandlerRFSCallBack
   );

   QLIB_API unsigned char QLIB_FTM_WLAN_Atheros_Save_BDF
   (
       HANDLE hResourceContext,
	   unsigned int saveOption,
       char *piFilename
   );
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_WLAN_SetInstance
   (
      HANDLE hResourceContext,
