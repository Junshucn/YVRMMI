/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_TDSCDMA_RF.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_TDSCDMA_RF.h#5 $
...
extern "C" {
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_TDSCDMA_SET_BURST_TX_PARAMS(HANDLE hResourceContext,
         ...
         unsigned short iPowerTS1,
         unsigned short iPowerTS2,
         unsigned short iPowerTS3,
         unsigned short iPowerTS4,
         unsigned short iPowerTS5,
