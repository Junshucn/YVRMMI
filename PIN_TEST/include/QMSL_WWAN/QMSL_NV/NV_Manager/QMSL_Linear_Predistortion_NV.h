/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/QMSL_NV/NV_Manager/QMSL_Linear_Predistortion_NV.h#3 $
...
public:
   ...
   */
   ...
   static const float QMSL_Linear_Predistortion_NV::ampl_in_self_cal[SELF_CAL_ENV_IN_NUM_SAMPLES];
#else
