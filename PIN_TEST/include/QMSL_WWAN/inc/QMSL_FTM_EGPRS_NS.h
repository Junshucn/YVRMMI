/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_EGPRS_NS.h#6 $
 * $DateTime: 2017/03/23 07:03:37 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   80-V3951-1 Enable/Disable Rx chain Section 3.13

   This command allows the user to select the required Rx chain(s). The status are reset upon power cycle.

      \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

      \param rxChainType = 0 - PRx only
                           1 - DRx only
                           2 - PRx + DRx
                           3 - No action
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_GSM_NS_CHAIN_SELECT(HANDLE hResourceContext, unsigned char rxChainType, unsigned char* iStatus);
