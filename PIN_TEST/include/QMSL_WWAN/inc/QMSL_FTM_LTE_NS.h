/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_LTE_NS.h#23 $
 * $DateTime: 2017/05/14 18:47:15 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NB_NS_START

   This command puts the UE in LTE NB Non-Signaling mode.
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_START( HANDLE hResourceContext, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NB_NS_IS_CONNECTED

   This command queries if the UE is in LTE NB Non-Signaling mode call.
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_IS_CONNECTED( HANDLE hResourceContext, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NB_NS_ACQ
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_ACQ( HANDLE hResourceContext, unsigned char iBand, unsigned long iEARFCN, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NS_START_DL_DP

   This command is used to start downlink-only reception on the UE

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param iCRNTI           = C-RNTI used by UE

   \param iDLLCID          = Downlink LCID (1..10)

   \param iNumRx           = Number of Rx paths to be configured, 2 or 4
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_START_DL_DP( HANDLE hResourceContext, unsigned short iCRNTI, unsigned char iDLLCID, unsigned char iNumRx, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NB_NS_START_DP
   ...
   \param iNUM_REP =  NPDCCH Number of repetitions.

   \param iSTART_SF_USS =  NPDCCH  starting subframe configuration for an NPDCCH UE-specific search space.
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_START_DP( HANDLE hResourceContext, unsigned short iCRNTI, unsigned char iNetworkSigValue, char iBSMaxPowerLimit,unsigned char iDLLCID, unsigned char iULLCID, unsigned char iNUM_REP, unsigned char iSTART_SF_USS, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NB_NS_STOP

   This command halts all outstanding operation and exits the LTE NB mode. After this command is executed,
   FTM_LTE_NB_NS_START command must be sent again to enter LTE NB mode.
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_STOP( HANDLE hResourceContext, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Non-Signaling Command, FTM_LTE_NB_NS_CONFIG_UL_WAVEFORM

   Configures the active resource blocks and modulation type for the LTE uplink waveform, overriding the settings in the DL DCI1.

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param iULModulationType  = UL Modulation Type
                     0 = BPSK
                     1 = QPSK
                  For NB1, the value can only be 0 for BPSK and 1 for QPSK. From NB1 L1, BPSK will map to MCS idx 1 and QPSK will map to MCS idx 6 in NB1 L1 part.

   \param iToneBandwidth =   NB1 Tone bandwidth
                  0 = SINGLE_TONE_3_75_KHZ
                  1 = SINGLE_TONE_15_KHZ
                  2 = MULTI_TONE_3
                  3 = MULTI_TONE_6
                  4 = MULTI_TONE_12


   \param iToneStartIndex = Starting tone index that will be active

   \param iTxPowerdBm = Tx pwr to be transmitted in the unit of dBm
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_CONFIG_UL_WAVEFORM( HANDLE hResourceContext, unsigned char iULModulationType, unsigned char iToneBandwidth, unsigned char iToneStartIndex, short iTxPowerdBm,  unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE NB Non-Signaling Command, FTM_LTE_NB_NS_CONFIG_UL_POWER
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_CONFIG_UL_POWER( HANDLE hResourceContext, short iTxLevel, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Non-Signaling Command, FTM_LTE_NB_NS_GET_DL_LEVEL

   Returns RX Level in dBm/10 units, for a specified receiver
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_GET_DL_LEVEL( HANDLE hResourceContext, short* iRxLeveldBm10, unsigned long* pStatus );
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_GET_DL_LEVEL_ENH( HANDLE hResourceContext, unsigned char iRxChain, unsigned char iRxCarrier, short* iRxLeveldBm10, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE NB Non-Signaling Command, FTM_LTE_NB_NS_RESET_DL_BLER_REPORT
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_RESET_DL_BLER_REPORT( HANDLE hResourceContext, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE NB Non-Signaling Command, FTM_LTE_NB_NS_GET_DL_BLER_REPORT

   Resets the downlink BLER accumulators for a specified receiver.

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param iTotalBlockReceived = Total number of blocks that have been received since FTM_LTE_NB_NS_RESET_DL_BLER_REPORT was called

   \param iTotalBlockError = Total number of blocks errors that have been received since FTM_LTE_NB_NS_RESET_DL_BLER_REPORT was called.

   \param iThroughput = Throughput, in bits/second, since FTM_LTE_NB_NS_RESET_DL_BLER_REPORT was called.
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NB_NS_GET_DL_BLER_REPORT( HANDLE hResourceContext, unsigned long* iTotalBlockReceived, unsigned long* iTotalBlockError, unsigned long* iThroughput, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   \return true if successful, false if fail.
   *******************************************************************************/
   QLIB_API unsigned char QLIB_LTE_NB_PDSCH_BLER_Stop_Log(HANDLE hResourceContext );

      /******************************************************************************/
   /**
   This command Measures the LTE NB PDSCH BLER value for a give Loopback Type and updates the pSE_BER_State pointer.
   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param pLTE_PDSCH_BLER_Status  = Pointer the LTE_PDSCH_BLER_Status structure defined in QLib_Defines.h

   \param iMeasurementCount = Number of ACKs and NACKs to be collected for each LTE NB PDSCH BLER measurement.

   \param iTimeOut_ms =  Time out duration before exiting the LTE NB PDSCH BLER measurement.

   \return true if successful, false if fail.
   *******************************************************************************/
   QLIB_API unsigned char QLIB_LTE_NB_PDSCH_BLER_DoMeasurement(
      HANDLE hResourceContext,
      void *pLTE_PDSCH_BLER_Status,
      unsigned long iMeasurementCount,
      unsigned long iTimeOut_ms
   ...
   /******************************************************************************/
   /**
   High level function to start NB PDSCH Logs, including setting the diagnostic log mask

   \return true if successful, false if fail.
   *******************************************************************************/
   QLIB_API unsigned char QLIB_LTE_NB_PDSCH_BLER_Start_Log(HANDLE hResourceContext );

   /******************************************************************************/
   /**
   High level function to stop NB PDSCH Logs, including setting the diagnostic log mask
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Non-Signaling Command, QLIB_FTM_LTE_NS_ENABLE_MULTI_SCELL_UL_DL_V2
   ...
   \return
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_ENABLE_MULTI_SCELL_UL_DL_V2 (HANDLE hResourceContext, unsigned char iulcarrier_cfg, unsigned char idlcarrier_cfg, void* pFTM_LTE_NS_Multi_SCC_UL_DL_Config,unsigned long *pstatus);
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Non-Signaling Command, FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK

   This command is used to send active DL carrier information to UE.

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param idlactive_carr = This is the active DL carrier bit mask.carrier 0 rx chain mask. Bit0 - PCC Bit1 - SCELL1 Bit2 - SCELL2
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK( HANDLE hResourceContext, unsigned short idlactive_carr, unsigned long *pstatus);
