/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_GSM_RF.h#15 $
 * $DateTime: 2017/02/04 20:45:09 $
 *
...
*******************************************************************************/
QLIB_API unsigned char QLIB_FTM_GSM_V4_CAL_GET_RESULTS( HANDLE hResourceContext, void* psGSM_V4_Cal_FTM_Results, bool enable_FBRx_only = false );
...
*******************************************************************************/
QLIB_API unsigned char QLIB_FTM_GSM_SET_DEVICE_AND_SIG_PATH( HANDLE hResourceContext, 
                                                             unsigned char iPrxDev, unsigned char iDrxDev, unsigned char iTxDev,
...
/******************************************************************************/
/**
QLIB_FTM_GSM_SET_RFM_PATH

Uses FTM_GSM_SET_RFM_PATH (FTM API) command for setting up PRx, DRx and Tx RFM Paths(SigPath + RFM Device + Antenna Path) to use in FTM mode.

\param hResourceContext   = Resource context that was returned from the call to QLIB_ConnectServer()
\param iNumBands          = Number of bands
\param iGsmBandRFMPathMap = Struct of ftm_gsm_set_rfm_path_type 

\return true if successful, false if fail.

\warning None.
*******************************************************************************/
QLIB_API unsigned char QLIB_FTM_GSM_SET_RFM_PATH( HANDLE hResourceContext, unsigned char iNumBands, void* iGsmBandRFMPathMap);
/******************************************************************************/
/**
