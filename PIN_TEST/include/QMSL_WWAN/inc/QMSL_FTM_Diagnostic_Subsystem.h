/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_Diagnostic_Subsystem.h#11 $
 * $DateTime: 2017/06/11 18:55:59 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************
                                    LTE HD FDD
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_SET_HD_FDD(
      HANDLE hResourceContext,
      unsigned char bEnable_HD_FDD ,
      unsigned char* piStatus
   );
    QLIB_API unsigned char QLIB_FTM_SET_NB1_MODE(
      HANDLE hResourceContext,
      unsigned char set_nb1_mode ,
      unsigned char* piStatus
   );
   ...
   *******************************************************************************/
   ...
   /**
   Enable/Disable Rx chain for LTE (80-VP457-1).

   When this command is called, a particular carrier's Rx chain described by iLTECarrierChainType is enabled/disabled.
   The status are reset upon power cycle.

   \param iLTECarrierChainType = Bit 7 to bit 4 - Carrier ID, for example, PCC - 0, SCC1 - 1, SCC2 - 2, and so on
                                 Bit 3 - enabling or disabling Rx3;  0 - Disable Rx3, 1 - Enable Rx3
                                 Bit 2 - enabling or disabling Rx2;  0 - Disable Rx2, 1 - Enable Rx2
                                 Bit 1 - enabling or disabling Rx1;  0 - Disable Rx1, 1 - Enable Rx1
                                 Bit 0 - enabling or disabling Rx0;  0 - Disable Rx0, 1 - Enable Rx0
   \endcode

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_DIAG_LTE_RX_CHAIN_SELECTION_COMMAND( HANDLE hResourceContext, unsigned char iLTECarrierChainType, unsigned short& errorCode);
