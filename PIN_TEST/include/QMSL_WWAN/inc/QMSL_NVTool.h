/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_NVTool.h#19 $
 * $DateTime: 2017/09/14 14:06:13 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Convert NV source XML to NV tree type source XML file

   \param hResourceContext   Resource context that was returned from the call to QLIB_ConnectServer()

   \param sNV_Src_Xml, NV source XML file path

   \param sNV_Dst_Xml, NV destination file path
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_NV_WriteToSourceTree(HANDLE hResourceContext, const char *sNV_Src_Xml, const char *sNV_Dst_Xml, int *iResultCode,  unsigned char dataFromBin=0);
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Get the byte size of the NV definition item with selected index

   \param hResourceContext   Resource context that was returned from the call to QLIB_ConnectServer()

   \param iIndex, should be between 0 to  GetNumOfNVDefinition() - 1

   \param iNVSize [out], the NV item byte size

   \param iResultCode, the result code, See QMSL_NVTool_ResultCode_Enum

   \note call QLIB_NV_GetNVSizeByIndex to determine the byte size of this NV item.

   \return true if result code is 0
   *******************************************************************************/
   QLIB_API unsigned char QLIB_NV_GetNVSizeByIndex(HANDLE hResourceContext, int iIndex, int *iNVSize, int *iResultCode);
   ...
   *******************************************************************************/
   ...
   \param bUncompress uncompress NV data
   ...
   \return true if result code is 0
   *******************************************************************************/
   QLIB_API unsigned char QLIB_NV_GetNVValueByteStreamByNVID_V2(HANDLE hResourceContext, int iNVId, unsigned char bUncompress, unsigned char *iNVValueBuffer, int* iSzOfBuffer, int *iResultCode);
