/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_RFCAL_NVManager.h#19 $
 * $DateTime: 2017/08/29 11:54:00 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Generate the NV items associated with GSM Tx self calibration.  The NV items include NV_GSM_<band>_AMAM_LINEAR_PA_RANGEA_F<n>_SEG<n>_I,
   NV_GSM_<band>_AMPM_LINEAR_PA_RANGEA_F<n>_SEG<n>_I, NV_GSM_AMAM_DYNAMIC_RANGE_I, NV_GSM_<band>_TX_AGC_SETTING_FOR_PRED_I
   ...
   \warning NV items are not written to the mobile station until QLIB_RFCAL_NV_Manager_WriteToPhone() is called
   *******************************************************************************/
   QLIB_API unsigned char QLIB_RFCAL_GSM_Tx_Self_Cal_Process_DPD(   HANDLE hResourceContext,
         unsigned short iNvModeId,
         void* aGSM_PreDist_Cal,
         void *aGSM_PreDist_Cal_NV,
         unsigned char bCachedByNVManager);
   ...
   *******************************************************************************/
   ...
   \param iTxAntennaPath [input] Tx Antenna Path

   \param iTxSigPath [input] Tx Signal Path

   \param iTxDev [input] RFM Device
   ...
   \param aGSM_Tx_Consolidated_Cal_NV [output] Pointer to QMSL_GSM_Tx_Calibration_Consolidated_NV struct
          containing NV items generated.

   \param iOrgPayloadSize  [input] The original size (bytes) of the payload in aGSM_Tx_Consolidated_Cal_NV.
            This is the number of bytes in the NV payload that contains valid data, which doesn't need to be overwritten.
   ...
   \warning NV items are not written to the mobile station  until
            QLIB_RFCAL_NV_Manager_WriteToPhone() is called
   *******************************************************************************/
   QLIB_API unsigned char QLIB_RFCal_GSM_V4_Cal_Tx_Generate_Consolidated_NV( HANDLE hResourceContext,
         unsigned short iNvModeId,
         unsigned char iTxAntennaPath,
         unsigned char iTxSigPath,
         unsigned char iTxDev,
         void* aGSM_V4_PCL_Cal,
         void* aGSM_V4_DPD_Control,
         void* aGSM_V4_DPD_Data,
         void* aGSM_Tx_Consolidated_Cal_NV,
         unsigned long iOrgPayloadSize,
         unsigned char bCachedByNVManager);
   ...
   *******************************************************************************/
   ...
   /*******************************************************************************/
	  QLIB_API unsigned char QLIB_RFCal_GSM_Tx_Self_Cal_Generate_Consolidated_NV
      (   HANDLE hResourceContext,
      unsigned short iNvModeId,
      unsigned char txAntPath,
      unsigned char rfmDevice,
      void* aGSM_DA_Cal,
	  unsigned long preDistCalNumChan,
	  unsigned short preDistCalRGI,
      void* aGSM_PreDist_Cal,
      void* aGSM_Tx_Cx_Cal_NV,
      unsigned char bCachedByNVManager);
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Get an RF NV item stored in NV Manager.  Call this function after QLIB_RFCAL_xxx_Results
   ...
   \param iBufferSize[output].  Size of the NV buffer  

   \param pNVitem[output].  Pointer to NV buffer  The function will fill up this data struture if the item has data.
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_GetBackupNVItem(   HANDLE hResourceContext,
         unsigned short iNVEnum,
         unsigned char* iStatus,
         unsigned int * iBufferSize,
         unsigned char * pNVItem);
