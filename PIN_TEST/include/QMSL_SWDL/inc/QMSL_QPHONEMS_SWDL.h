/******************************************************************************
* $Header: //depot/HTE/QDART/QMSL6.1/QMSL_SWDL/inc/QMSL_QPHONEMS_SWDL.h#9 $
* $DateTime: 2017/02/19 22:34:21 $
*
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param bEraseCDTPartitionFirst = If this value is set to true, a erase command is send to CDT Partition before download

   \param iEraseTimeout = Command timeout setting for erase command

   \param bOptimizedCDTWrite = If this value is set to true, downloader skip all 0 data chunks during flash write
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_QPHONEMS_UploadEmmcUserParitionImageWithCDT(      
      ...
      unsigned long iSleepTimeToDOWNLOADmode,
      unsigned long iSleepTimeToGOcommand,
      unsigned char bEraseCDTPartitionFirst,
      unsigned long iEraseTimeout,
      unsigned char bOptimizedCDTWrite,
      unsigned long* iErrorCode
      );
