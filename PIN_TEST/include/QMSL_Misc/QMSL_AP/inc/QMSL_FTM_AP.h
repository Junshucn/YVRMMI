/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Misc/QMSL_AP/inc/QMSL_FTM_AP.h#8 $
 * $DateTime: 2017/07/14 00:00:58 $
 *
 *
 ******************************************************************************
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode(FFBM/QMMI) : Application processor test command: FTM_AP_SET_TOKEN

   Set a token string before test start then write to result file when test finished.
   ...
   \param sToken Token string in ASCII
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_AP_SET_TOKEN ( HANDLE hResourceContext, unsigned short* iFTM_Error_Code, char* sToken);
