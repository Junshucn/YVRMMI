/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Misc/QMSL_SECURITY_ID_SENSOR/inc/QMSL_FTM_SECURITY_ID_SENSOR.h#8 $
 * $DateTime: 2017/05/19 12:44:41 $
 *
 *
 ******************************************************************************
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   Factory Test Mode SECURITY_ID_SENSOR, SECURITY_ID_SENSOR Get Max Buffer Length
      Returns the max. number of bytes that can be transferred over the FTM link in a single transaction
   ...
   *******************************************************************************/
   ...
   Factory Test Mode SECURITY_ID_SENSOR, SECURITY_ID_SENSOR Read Image
      Copies a part of a previously scanned image into a buffer
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode SECURITY_ID_SENSOR, SECURITY_ID_SENSOR Read Image Info
      Returns information (dimensions, data format) of the image currently stored in the internal image buffer
   ...
   \code
      ...
      4 = SECURITY_ID_SENSOR_NOT_INITIALIZED,
   \endcode
   \param piWidth = Width of image in pixels
   \param piHeight = Height of image in pixels
   \param piImageSize = Total size of image in bytes
   \param piImageFormat = Image format (0- 8 bit image, 1 - 16 bit image,  2 - 32 bit image )
   \param piTemperature = Temperature at which image was taken in 0.1 degrees C

   \return 1 if successful, 0 if fail

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_SECURITY_ID_SENSOR_READ_IMAGE_INFO( 
      HANDLE hResourceContext, 
      unsigned short* piSECURITY_ID_SENSORStatus,
      unsigned int* piWidth,
      unsigned int* piHeight,
      unsigned int* piImageSize,
      unsigned int* piImageFormat,
      signed int* piTemperature
      );
   ...
   *******************************************************************************/
   ...
   \param piSensorHeight = Height of sensor in pixels
   \param piLivenessSupport = Indicates support of liveness detection
   \param psTFTID = TFT ID as string representation. Must be initialized to a buffer of at least 26 bytes (25 bytes + zero) by caller
   \code
      0 = Not supported
      1 = Supported
   \endcode
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_SECURITY_ID_SENSOR_READ_INFO( 
      ...
      unsigned int* piSensorHeight,
      unsigned char* piLivenessSupport,
	  unsigned char* psTFTID
      );
  ...
  /******************************************************************************/
   ...
   \param iDataLength = Length of parameter data
