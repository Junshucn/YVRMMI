/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_UIM/inc/QMSL_GSDI_Diag.h#10 $
 * $DateTime: 2016/12/28 01:48:37 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param timeout_in_ms = command timeout in ms, if this is set to 0 default timeout is 10s
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_SIMLOCK_UNLOCK_CMD(HANDLE hResourceContext, unsigned char slot, unsigned char category, unsigned char ck_len, unsigned char *ck_data, unsigned long *status, unsigned long timeout_in_ms);
   ...
   \param potential_lock_num = Stores the potential simlock feature number. 
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_SIMLOCK_GET_STATUS_CMD(HANDLE hResourceContext, unsigned long *status, unsigned char *slotpolicy, unsigned char *subpolicy, unsigned short *potential_lock_num, unsigned char *lock_info);
